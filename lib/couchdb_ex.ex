defmodule CouchDBEx do
  ...
  * `shards` - number of shards for this database, defaults to 8
  ...
  def db_create(db_name, opts \\ []),
    do: GenServer.call(CouchDBEx.Worker, {:db_create, db_name, opts})
  ...
  def document_insert_one(doc, db),
    do: GenServer.call(CouchDBEx.Worker, {:document_insert, doc, db})

  @doc """
  Insert or update a single document
  """
  @spec document_insert_with_id(doc :: map, db :: String.t(), id :: String.t()) :: couchdb_res
  def document_insert_with_id(doc, db, id),
    do: GenServer.call(CouchDBEx.Worker, {:document_insert_id, doc, db, id})
  ...
  * `attachments` - should the request return full information about attachments
  ...
  def document_get(id, db, opts \\ []),
    do: GenServer.call(CouchDBEx.Worker, {:document_get, id, db, opts})
  ...
  """
  @spec document_delete_one(id :: String.t(), rev :: String.t(), db :: String.t()) ::
          :ok | {:error, term}
  def document_delete_one(id, rev, db),
    do: GenServer.call(CouchDBEx.Worker, {:document_delete, {id, rev}, db})
  ...
  """
  @spec document_delete_many(id_rev :: [{String.t(), String.t()}], db :: String.t()) ::
          couchdb_res
  ...
  * `content_type` - content type of the attachment in the standard format (e.g. `text/plain`),
  ...
  def attachment_upload(db, id, doc_rev, name, bindata, opts \\ []) do
    GenServer.call(
      CouchDBEx.Worker,
      {:attachment_upload, db, id, doc_rev, {name, bindata}, opts},
      :infinity
    )
  end
  ...
  """
  @spec index_create(index :: map | [String.t()], db :: String.t(), opts :: keyword) ::
          couchdb_res
  ...
  """
  @spec index_delete(db :: String.t(), ddoc :: String.t(), index_name :: String.t()) ::
          :ok | {:error, term}
  ...
  def replicate(src, target, opts \\ []),
    do: GenServer.call(CouchDBEx.Worker, {:replicate, src, target, opts})
  ...
  * `heartbeat` is `25`, this is needed to keep the connection alive,
  ...
  def ddoc_insert(ddoc, name, db),
    do: GenServer.call(CouchDBEx.Worker, {:ddoc_insert, ddoc, name, db})
  ...
  def ddoc_get(name, db, opts \\ []),
    do: GenServer.call(CouchDBEx.Worker, {:ddoc_get, name, db, opts})
  ...
  def ddoc_delete(name, rev, db),
    do: GenServer.call(CouchDBEx.Worker, {:ddoc_delete, name, rev, db})
  ...
  """
  @spec view_exec(ddoc :: String.t(), view :: String.t(), db :: String.t(), opts :: keyword) ::
          couchdb_res
